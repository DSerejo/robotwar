...
eval(fs.readFileSync('./public/engine/cocos2d/core/platform/CCMacro.js') + '');
eval(fs.readFileSync('./public/engine/cocos2d/core/cocoa/CCGeometry.js') + '');
eval(fs.readFileSync('./public/engine/cocos2d/core/support/CCPointExtension.js') + '');
eval(fs.readFileSync('./public/src/common/Globals.js') + '');
eval(fs.readFileSync('./public/src/common/Math.js') + '');
var ClassManager = {
