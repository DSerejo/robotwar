...
var Room = function(id,io,clientManager){
    ...
    this.start = function(){
        ...
        this.newGame = new start(this.players,entities);
        this.running = true;
    };
    ...
    this.notifyPlayers = function(reason){

        _.each(this.players,function(socket){
            socket.send(JSON.stringify({m:'gameClosed',d:reason}))
        })
    }
};
Room.closeReasons = {
